...
desc = (
    ...
    "removed. Full quality images can be downloaded from the sidebar. "
    "This code is open source and available [here]"
    "(https://github.com/gabrielldn/SecureFlow-CI-CD) on GitHub. "
    "Special thanks to the [rembg library]"
    "(https://github.com/danielgatis/rembg) :grin:"
)
